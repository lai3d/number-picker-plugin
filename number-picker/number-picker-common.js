/**
 * Created by CgPanda on 31/10/16.
 */
...
var NumberPicker = (function (_super) {
    ...
    NumberPicker.valueProperty = new dObservable.Property("value", "NumberPicker", new proxy.PropertyMetadata(0
        , dObservable.PropertyMetadataSettings.AffectsLayout));
    return NumberPicker;
})(view.View);
